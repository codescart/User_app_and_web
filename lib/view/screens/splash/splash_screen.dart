...
class _SplashScreenState extends State<SplashScreen> {
  ...
  aj()async{
    ...
    setState(() {
      log= prefs1.getString('comp_namef');
      logos= prefs1.getString('logof');
    });
  }
  @override
  void dispose() {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.network(logos, width: 170,),
            Text(log, style: rubikBold.copyWith(fontSize: 30, color: Colors.white)),
          ],
        ),
      ),
    );
