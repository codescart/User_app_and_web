          ...
          Padding(
            ...
            Center(child: Padding(
              ...
              /*child: ElevatedButton(
                style : ElevatedButton.styleFrom(primary: ColorResources.getWhiteAndBlackColor(context), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
                onPressed: (){
                  seeMoreItems();
                },
                child: Padding(
                  padding: const EdgeInsets.symmetric(vertical: 10),
                  child: Text(getTranslated('see_more', context), style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE)),
                ),
              ),*/
